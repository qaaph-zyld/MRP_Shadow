/*
Inventory Per Project Report
----------------------------
This query provides a summarized view of inventory data grouped by project, plant, and other key dimensions.
...
Usage:
- Use for project-based inventory analysis and reporting
- Can be integrated with visualization tools for trend analysis
- Supports financial reporting for project-based accounting
*/
